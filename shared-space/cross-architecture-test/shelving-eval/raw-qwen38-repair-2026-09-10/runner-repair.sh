...
echo "##### REPAIR TEST START $(date -Is)"
run_arm K0  $EVAL/episodes/T1.md       original live
run_arm K1  $EVAL/episodes/T1.md       revised  live
run_arm D1  $EVAL/episodes/T1.md       none     variant
run_arm K1c $EVAL/variants/T1-clean.md revised  live
echo "##### REPAIR TEST COMPLETE $(date -Is)"
