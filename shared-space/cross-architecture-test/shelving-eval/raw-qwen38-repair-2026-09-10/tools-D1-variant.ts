...
export const TOOLS: Tool[] = [
  ...
  },
  {
    ...
    description:
      ...
      "The block remains in the registry as inactive and can be reactivated unchanged via recompress, " +
      "or corrected by compressing the same range again with a revised summary.",
    inputSchema: {
      type: "object",
      properties: {
        session_id: {
  ...
  },
  {
    ...
    description:
      ...
      "recompress cannot change the text: to correct a summary that turned out wrong (for example, one whose stated confidence " +
      "exceeded its evidence), decompress it, then compress the same range again with a revised summary.",
    inputSchema: {
      type: "object",
      properties: {
        session_id: {
